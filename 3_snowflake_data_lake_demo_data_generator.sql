...
INSERT INTO STG.CILENT1_EMAIL_GOWS.RAW_PERSON
SELECT FIRST_NAME, 
    LAST_NAME, 
...
INSERT INTO STG.CILENT2_EMAIL_MSTM.RAW_PERSON
SELECT FIRST_NAME, 
    LAST_NAME, 
    ARRAY_CONSTRUCT('C-level','VP','Director','Manager','Employee')[UNIFORM(0, 4, RANDOM(11))::NUMBER] TITLE, 
...
INSERT INTO STG.CILENT1_EMAIL_GOWS.RAW_MESSAGE
SELECT M.SUBJECT, 
...
JOIN STG.CILENT1_EMAIL_GOWS.RAW_PERSON S
ON M.FILE_ROW_NUMBER = S.FILE_ROW_NUMBER
LEFT JOIN STG.CILENT1_EMAIL_GOWS.RAW_PERSON A
ON NOT ARRAY_CONTAINS(S.EMAIL_ADDRESS, A.EMAIL_ADDRESS)
GROUP BY 1,4,13,14
;

INSERT INTO STG.CILENT2_EMAIL_MSTM.RAW_MESSAGE
SELECT M.SUBJECT, 
    ARRAY_AGG(S.EMAIL_ADDRESS[0])[0] SENDER, 
    ARRAY_SLICE(
          ARRAY_AGG(DISTINCT A.EMAIL_ADDRESS[0]),
...
JOIN STG.CILENT2_EMAIL_MSTM.RAW_PERSON S
ON M.FILE_ROW_NUMBER = S.FILE_ROW_NUMBER
LEFT JOIN STG.CILENT2_EMAIL_MSTM.RAW_PERSON A
ON NOT ARRAY_CONTAINS(S.EMAIL_ADDRESS, A.EMAIL_ADDRESS)
GROUP BY 1,4,13,14
;
...
-- Check the raw data
SELECT * FROM CILENT1_EMAIL_GOWS.RAW_PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.RAW_MESSAGE;
SELECT * FROM CILENT1_EMAIL_GOWS.RAW_DATA3;

SELECT * FROM CILENT2_EMAIL_MSTM.RAW_PERSON;
SELECT * FROM STG.CILENT2_EMAIL_MSTM.RAW_MESSAGE;

-- Check the loaded stage data
SELECT * FROM CILENT1_EMAIL_GOWS.PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.MESSAGE;
SELECT * FROM CILENT1_EMAIL_GOWS.DATA3;

SELECT * FROM CILENT2_EMAIL_MSTM.PERSON;
SELECT * FROM CILENT2_EMAIL_MSTM.MESSAGE;
...
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_MESSAGE;
SELECT * FROM STG.CILENT1_EMAIL_GOWS.DIGEST_DATA3;

SELECT * FROM CILENT2_EMAIL_MSTM.DIGEST_PERSON;
SELECT * FROM STG.CILENT2_EMAIL_MSTM.DIGEST_MESSAGE;

-- Check the cross reference data
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_MESSAGE;
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_DATA3;

SELECT * FROM CILENT2_EMAIL_MSTM.XREF_PERSON;
SELECT * FROM CILENT2_EMAIL_MSTM.XREF_MESSAGE;
...
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_MESSAGE;
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_PERSON_EMAIL;
SELECT * FROM CILENT1_EMAIL_GOWS.DIGEST_MESSAGE_EMAIL;

SELECT * FROM CILENT2_EMAIL_MSTM.DIGEST_PERSON;
SELECT * FROM CILENT2_EMAIL_MSTM.DIGEST_MESSAGE;
SELECT * FROM CILENT2_EMAIL_MSTM.DIGEST_PERSON_EMAIL;
SELECT * FROM CILENT2_EMAIL_MSTM.DIGEST_MESSAGE_EMAIL;
...
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_PERSON;
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_MESSAGE;
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_PERSON_EMAIL;
SELECT * FROM CILENT1_EMAIL_GOWS.XREF_MESSAGE_EMAIL;

SELECT * FROM CILENT2_EMAIL_MSTM.XREF_PERSON;
SELECT * FROM CILENT2_EMAIL_MSTM.XREF_MESSAGE;
SELECT * FROM CILENT2_EMAIL_MSTM.XREF_PERSON_EMAIL;
SELECT * FROM CILENT2_EMAIL_MSTM.XREF_MESSAGE_EMAIL;
*/
